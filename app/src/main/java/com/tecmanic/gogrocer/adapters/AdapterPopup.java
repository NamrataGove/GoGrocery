...
public class AdapterPopup extends RecyclerView.Adapter<AdapterPopup.Holder> {
    ...
    public void onBindViewHolder(@NonNull final Holder holder, int i) {
        ...
        Picasso.get().load(IMG_URL + selectAreaModel.getVarientImage()).networkPolicy(NetworkPolicy.NO_CACHE,NetworkPolicy.NO_STORE).placeholder(R.drawable.splashicon).into(holder.prodImage);
