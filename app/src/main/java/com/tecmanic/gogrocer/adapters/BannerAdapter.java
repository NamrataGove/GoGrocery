...
//        Log.e("tag", "onBindViewHolder: " + images.get(position));
        Picasso.get().load(BaseURL.BANN_IMG_URL + images.get(position).getBanner_image()).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).error(R.drawable.splashicon).into(holder.img);
    }
